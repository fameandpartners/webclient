...
class CustomizeInline extends React.PureComponent<Props, State> {
    ...
    private getSelectedComponents(): Component[] {
        ...
        const { product, product: { groups }, components } = uncomittedCustomizedProduct;
    ...
    private renderHeader() {
        const {
            currentGroup, currentSectionGroup, customizeBeforeAddingToCart, uncomittedCustomizedProduct
        } = this.props;
        ...
        return (
                <div className={'customization-header'}>
                    ...
                    {
                        showErrors && !customizeBeforeAddingToCart && <div className="info-box">
                            <FormattedMessage
                                id="PDP.CustomizationModal.Error.FillOut"
                                defaultMessage="Oh no, it seems that you haven't completed this, yet."
                            />
                        </div>
                    }
                    {
                        customizeBeforeAddingToCart && <div className="info-box">
                            <FormattedMessage
                                id="PDP.CustomizationModal.Error.FillOutBeforeAddingToCart"
                                defaultMessage="One last thing before you can add this product to your cart..."
                            />
                        </div>
                    }
