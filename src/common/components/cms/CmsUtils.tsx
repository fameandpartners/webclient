...
export const CmsImage: React.SFC<{media: CmsAssetImage, dontMaintainAspectRatio?: boolean}> = ({ media, dontMaintainAspectRatio }) => {
    ...
    return (
        <div className="ImageWrapper" style={{position: 'relative', paddingBottom: dontMaintainAspectRatio ? undefined : `${media.height * 100.0 / media.width}%`, backgroundColor: 'transparent'}}>
