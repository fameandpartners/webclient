...
docker build --build-arg CIRCLE_SHA1=$CIRCLE_SHA1 --build-arg CIRCLE_BRANCH=$CIRCLE_BRANCH --build-arg CIRCLE_BUILD_NUM=$CIRCLE_BUILD_NUM -t $NAME:$VERSION .
...
aws elasticbeanstalk create-application-version --application-name "Webclient" \
